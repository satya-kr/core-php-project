      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            ?>
            <form name="student_form" method="post" action="hwnd_student.php" class="forms-sample">
              <?php
              if ( !empty( $edit_id ) ) {
                ?>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleInputUsername1">Mother's Name: <span style="color:red;">*</span></label>
                <input type="text" name="mothers_name" value="<?php echo $data_query['student_mothers_name']; ?>" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Enter Mothers Name" required>
              </div>
              <div class="form-group">
                ...
                <input type="text" name="mobile_no" value="<?php echo $data_query['student_phone_no']; ?>" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Enter Mobile No." required>
              </div>
              <div class="form-group">
                <label for="exampleInputUsername1">Address:<span style="color:red;">*</span> </label>
                  <textarea class="form-control" name="student_address" rows="8" required><?php echo $data_query['student_address']; ?></textarea>
              </div>
                <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleInputUsername1">Roll No. : <span style="color:red;">*</span></label>
                <input type="text" name="student_roll_no" value="<?php echo $data_query['student_roll_no']; ?>" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Enter Roll No." required>
              </div>
              ...
              <div class="form-group">
                <label for="exampleInputUsername1">Mother's Name: <span style="color:red;">*</span></label>
                <input type="text" name="mothers_name" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Enter Mothers Name" required>
              </div>
                <div class="form-group">
                <label for="exampleInputUsername1">Email Id.:<span style="color:red;">*</span> </label>
              ...
              <div class="form-group">
                <label for="exampleInputUsername1">Address: <span style="color:red;">*</span></label>
                  <textarea class="form-control" name="student_address" rows="8" required></textarea>
              </div>
                <div class="form-group">
                <label for="exampleInputUsername1">Class Name:<span style="color:red;">*</span> </label>
                <select name="class_name" required>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleInputUsername1">Roll No. :<span style="color:red;">*</span> </label>
                <input type="text" name="student_roll_no" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Enter Roll No." required>
              </div>

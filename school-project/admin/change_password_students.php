...
<?php
    $sql = "select * from peters_student where student_id ='" . $_SESSION[ "login_id" ] . "' and login_type='students'";
...
<div class="page-content">
  ...
  <div class="col-md-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
          <h6 class="card-title">Student change password</h6>
        <form name="change_pass_form" method="post" action="hwnd_change_pass_students.php" class="forms-sample">
            
          <div class="form-group">
            <label for="exampleInputUsername1">Username :<span style="color:red;">*</span> </label>
            <input type="text" name="user_student" value="<?php echo $data_query['student_username']; ?>" class="form-control" id="exampleInputUsername1" autocomplete="off" required placeholder="User Name" >
          </div>
            
          <div class="form-group">
            <label for="exampleInputUsername1">Old Password : <span style="color:red;">*</span></label>
            <input type="text" name="old_password" value="<?php echo $data_query['student_password']; ?>" class="form-control" id="exampleInputUsername1" autocomplete="off" required placeholder="Old Password">
          </div>
        ...
        <input type="hidden" name="student_id" id="student_id" value="<?php echo $data_query['student_id']; ?>">

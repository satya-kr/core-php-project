                ...
                <table id="dataTableExample" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <!-- <td>
                          <?php 
                             /* $teacher_subject = explode(',',$data_query['teachers_subject']);
                              $total_subject = count($teacher_subject);
                              for($b=0; $b<$total_subject; $b++)
                              {
                                  //echo $a.'<br>';
                                  $subject_id = $teacher_subject[$b];
                                  ...
                                  echo $data_query_subject['subject_name'].'&nbsp;&nbsp;';
                              }*/
                          ?>
                      ...
                      <td><?php  echo $data_query['teachers_phone_no'];?></td>
                        <td><a href="assign_teachers.php?id=<?php echo $data_query['teachers_id'];?>"  class="btn btn-success">Assign Class</a></td>
                        <?php
                          ...
                          {
                          ?>
                        <td><a href="edit_assign_teachers.php?id=<?php echo $data_query['teachers_id'];?>"  class="btn btn-primary">Edit Assign Class</a></td>
                        <?php
                          } else {
                              ?>
                        <td><a href="javascript:void(0);"  class="btn btn-danger">Not Assign Class</a></td>
                        <?php
                          }
                        ?>

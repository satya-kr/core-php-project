...
$query = $DBcon->query("SELECT * FROM cusers WHERE user = ".$_SESSION['user']);
...
if(isset($_POST['submit']))
{
  ...
  $name = strip_tags($_POST['name']);
	...
	$query= "UPDATE cusers SET name='$name' ,email='$email' ,phone='$phone' ,location='$loc' WHERE  user_id=".$_SESSION['user'];

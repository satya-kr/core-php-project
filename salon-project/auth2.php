	...
	<div class="row">
		<div class="col-md-6 col-md-offset-3 col-md-4 col-sm-offset-3  ">
			<!--div class="panel panel-default">
				...
				<!-- Front side -->
				<div class="form__login" id="logfrm" align="center">
				...
				<div class="text-right p-t-8 p-b-34">
					...
					<div class="txt1 text-center p-t-54 p-b-20">
						<span>
							<a href="#" class="txt2"><label for="flipper__checkbox" id="logfrmbtn" class="txt1 form__link">Register Here</label> Or Sign Up Using</a>
						</span>
					</div>
				...
				<div class="form__signup" id="singfrm" >
				 <!--div class="form__login" align="center"-->
					...
					<form class="login100-form validate-form" action="auth2.php" method="POST">
						<div class="row">
		          <div class="input-field col s12 center">
		            <img src="images/Partner_App_Icon-04.png" alt="" width="200" style="margin-left:50px;margin-right:50px;" class="responsive-img valign profile-image-login">
		           <center><font size="2" color="#ff0000"><?php
				...
				<div class="text-right p-t-8 p-b-34">
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							<button type="submit" name="reg" class="login100-form-btn">
								Register
							</button>
						</div>
					</div>
					...
					$(document).ready(function(){
						...
						<span>
							Already Registered <a href="#" class="txt2">&nbsp;<label for="flipper__checkbox" id="singfrmbtn" class="txt1 form__link">Signin Here</a></label>&nbsp; Or Sign Up Using
						</span>
					</div>
